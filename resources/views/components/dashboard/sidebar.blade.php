<aside class="w-64 bg-white border-r p-6 rounded-xl">
    <div class="text-center mb-6">
        <img src="{{ auth()->user()->profile_photo_url ?? '/images/default-user.jpg' }}" class="w-20 h-20 rounded-full mx-auto mt-5 mb-10">
    ...
    <nav class="space-y-2">
        ...
        <a href="{{ route('profile.show', auth()->id()) }}" class="block py-2 px-3 rounded hover:bg-gray-100">Mi Perfil</a>
        <a href="{{ route('applications.index') }}" class="block py-2 px-3 rounded hover:bg-gray-100">Mis Postulaciones</a>
        @endrole
