...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/verifications/history', [AdminVerificationController::class, 'history'])
        ->name('admin.verifications.history');

    Route::get('/verifications/user/{user}', [AdminVerificationController::class, 'userHistory'])
        ->name('admin.verifications.user.history');
